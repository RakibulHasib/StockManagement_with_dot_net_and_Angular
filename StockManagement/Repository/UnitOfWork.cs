...
namespace StockManagement.Repository
{
    public class UnitOfWork : IDisposable
    {
        ...
        public Repository<ProductStockLog, Guid> ProductStockLog { get; }
        ...
        public Repository<ConcernUserCompanyMapping, int> ConcernUserCompanyMapping { get; }
        ...
        public UnitOfWork(StockDBContext context, Repository<User, int> users, Repository<Product, int> product, Repository<ProductStockLog, Guid> productStockLog, Repository<Company, int> company, Repository<Stock, long> stock, Repository<StockDetail, Guid> stockDetail, Repository<SalesDistribute, long> salesDistribute, Repository<SalesDistributeDetail, Guid> salesDistributeDetail, Repository<ConcernPerson, int> concernPerson, Repository<ConcernUserCompanyMapping, int> concernUserCompanyMapping, Repository<RoleMaster, int> roleMaster, Repository<RoleAssagin, int> roleAssagin)
        {
            ...
            ConcernUserCompanyMapping = concernUserCompanyMapping;
            Users = users;
