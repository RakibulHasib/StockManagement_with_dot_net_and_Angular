    ...
    const actionTemplate = () => {
        return (
            <>
                ...
                <Button icon="pi pi-search" type="button" className={classNames("p-button-rounded p-button-text p-mb-1")}></Button>
            </>
        );
    };
                    ...
                    <div className="widget-chat">
                        <ul ref={chatcontainer}>
                            {chatMessages.map((chatMessage, i) => {
                                ...
                                return (
                                    <li key={i} className={classNames("p-d-flex p-ai-start", { from: chatMessage.from, "own p-jc-end": !chatMessage.from, "p-mb-3": !last, "p-mb-1": last })}>
                                        ...
                                        <div className={classNames("messages p-d-flex p-flex-column", { "p-ai-start": chatMessage.from, "p-ai-end": !chatMessage.from })}>
                                            {chatMessage.messages.map((message, i) => {
                                                const first = i === 0;
                                                return (
                                                    <span key={i} className={classNames("message", { "cyan-bgcolor": chatMessage.from, "pink-bgcolor": !chatMessage.from, "p-mt-1": !first })}>
                                                        {message}
                                                    </span>
                                                );
                                            })}
